...
/*
 * mt48lc16m16a2_ctrl - SDR SDRAM controller (wishbone version)
 * Target devices: Micron MT48LC16M16A2, Winbond W9816G6J (x16, 16M x 16)
 *
 * Copyright (c) 2022-2025 Hirosh Dabui <hirosh@dabui.de>
 * Copyright (C) 2026 Lone Dynamics Corporation <info@lonedynamics.com>
 *
...
/*
 * 2026-08-16: Ported to Wishbone bus by Machdyne; tested with W9825G6KH-6.
 */
...
module sdram_wb #(
  ...
  wire [12:0] col_ap = {3'b001, wb_adr_i[10:2], 1'b0}; // A12..A10=001, A0=0
  wire [12:0] col_ko = {3'b000, wb_adr_i[10:2], 1'b0}; // A12..A10=000, A0=0
  ...
  // -------------------------------------------------
  wire [1:0]  cur_bank_w = wb_adr_i[22:21];
  wire [12:0] cur_row_w  = {wb_adr_i[24:23], wb_adr_i[20:10]};
