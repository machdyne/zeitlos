...
static const dock_app_t dock_candidates[] = {
	...
	// PLACEHOLDER ICON. sw/data/icons/icon-text.png was generated by
	// a script rather than drawn -- it is a legible sheet-of-paper
	// shape and nothing more. Replace the PNG and re-run
	// gen_dock_icon_data.py; nothing here or in dock_icons.c needs
	// touching for that.
	{ "text",		z_icon_text_data  },
	// PLACEHOLDER ICON, same as text's -- generated rather than
	// drawn. Replace sw/data/icons/icon-files.png and re-run
	// gen_dock_icon_data.py.
	{ "files",		z_icon_files_data },
	// PLACEHOLDER ICON -- generated, not drawn. Replace
	// sw/data/icons/icon-info.png and re-run gen_dock_icon_data.py.
	{ "info",		z_icon_info_data  },
	// PLACEHOLDER ICON -- generated, not drawn. Replace
	// sw/data/icons/icon-settings.png and re-run
	// gen_dock_icon_data.py.
	{ "settings",	z_icon_settings_data },
	// PLACEHOLDER ICON -- generated, not drawn. Replace
	// sw/data/icons/icon-calc.png and re-run gen_dock_icon_data.py.
	{ "calc",		z_icon_calc_data  },
	// PLACEHOLDER ICON -- generated, not drawn. Replace
	// sw/data/icons/icon-read.png and re-run gen_dock_icon_data.py.
