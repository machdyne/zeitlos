 ...
 *
 * Transport button faces for sw/apps/play.
 *
...
extern const uint8_t play_icon_play[32];
extern const uint8_t play_icon_pause[32];
extern const uint8_t play_icon_stop[32];
