...
// `ETH_RX_SLOTS: 4 on every board today, but a per-build choice (see
// rtl/boards.vh). A bitstream that predates the field reads 0 there
// and had 4, so 0 is reported as 4.
