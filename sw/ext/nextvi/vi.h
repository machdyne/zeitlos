...
#ifdef ZEITLOS
/* Makes every byte one character -- call once before anything else.
 * See uc.c for why this is required rather than optional. */
void uc_bytemode(void);
#endif
...
/* ZEITLOS: nonzero while the editor is reading typed text rather than
 * commands -- see the wrappers at the end of led.c. */
